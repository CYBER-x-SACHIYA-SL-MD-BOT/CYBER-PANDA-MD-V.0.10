...
module.exports = {
    ...
    run: async (sock, message, args, { sender, jid, contextInfo }) => {
        ...
        const ownerName   = config.OWNER_NAME || '⛁ CYBER PANDA MD ⛁';
        ...
        await sock.sendMessage(sender, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    thumbnailUrl: config.ALIVE_IMG || 'https://i.ibb.co/xqd5hcNw/Dark-E-sports-Illustrative-Panda-Face-Gaming-Logo.jpg',
