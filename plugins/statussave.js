    ...
    run: async (sock, message, args, { sender, contextInfo, reply }) => {
        try {
            ...
            const caption = msgContent.caption
                || `📥 *Status saved by ${getStr('botName') || '⛁ CYBER PANDA MD ⛁'}*`;
            ...
            await sock.sendMessage(sender, {
                ...
                contextInfo: {
                    ...
                    externalAdReply: {
                        title:        'Status Saved ✅',
                        body:         (getStr('botName') || '⛁ CYBER PANDA MD ⛁') + ' · Status Downloader',
                        thumbnailUrl: getStr('pic1') || 'https://i.ibb.co/xqd5hcNw/Dark-E-sports-Illustrative-Panda-Face-Gaming-Logo.jpg',
                        mediaType:    1
                    }
                }
            }, { quoted: message });
