// core.js — Updated with fixes for group functionality and error handling
    ...
    try {
        ...
        if (sid && hasTilde) {
            ...
            if (!fs.existsSync(credsPath)) {
                ...
                if (header !== "CYBER PANDA MD" || !b64data) {
...
const globalContextInfo = {
    ...
    forwardedNewsletterMessageInfo: {
        ...
        newsletterName: '⛁ CYBER X SACHIYA ⛁',
        serverMessageId: 144
    }
};
...
function generateFancyBio() {
    ...
    const bios = [
        ...
        `⚡ CYBER PANDA MD ACTIVE ⛁ ${timeStr} ⛁ ${dateStr} ⛁`,
        `💫 ${config.BOT_NAME} Operational ⛁ ${dateStr} ⛁`,
        `🚀 CYBER PANDA MD Live ⛁ ${dateStr} ⛁ ${timeStr} ⛁`,
...
app.get('/', (req, res) => {
    const html = path.join(__dirname, 'smm', 'panda.html');
...
(async () => {
    try {
        ...
        console.log('╔══════════════════════════════════════════╗');
        console.log('║                                          ║');
        console.log('║    ___   ___  _   _   __   ___          ║');
        console.log('║   | _ \\ / _ \\| \\ | | |  \\ / _ \\        ║');
        console.log('║   | |_) | | | |  \\| | | | | | | |       ║');
